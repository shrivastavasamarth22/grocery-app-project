...
!function () {
    ...
    })), $(".flatpickr").length && flatpickr(".flatpickr", {disableMobile: !0}), $(".stopevent").length && $(document).on("off.bs.collapse.data-api", ".stopevent", (function (e) {
        e.stopPropagation()
    ...
    Array.from(e).forEach((function (e) {
        var t = e.querySelector(".selectValue"), n = e.querySelector("ul");
