...
window.theme = theme, function () {
    ...
    $("#revenueChart").length && (e = {
        series: [{name: "Revenue", data: revenue_data}, {name: "Order Count", data: order_count_data}],
        labels: months,
        ...
        legend: {
            position: "top", fontWeight: 600, color: window.theme.gray600, markers: {
                width: 8,
                height: 8,
                strokeWidth: 0,
                strokeColor: "#fff",
        ...
        plotOptions: {
            pie: {
                donut: {
                    size: "85%", background: "transparent", labels: {
                        show: !0, name: {
                            show: !0,
                            fontSize: "22px",
                            fontFamily: '"Inter", "sans-serif"',
